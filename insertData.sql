...
insert into softwareTab values (softwareIdN.nextval, 'Borderlands: The Pre-Sequel', to_date('2014.10.14', 'YYYY.MM.DD'), 39.99, 'LAUNCH INTO THE BORDERLANDS UNIVERSE AND SHOOT ''N'' LOOT YOUR WAY THROUGH A BRAND NEW ADVENTURE THAT ROCKETS YOU ONTO PANDORA''S MOON IN BORDERLANDS: THE PRE-SEQUEL!', 4.2, 18, '2K Games');
insert into softwareTab values (softwareIdN.nextval, 'Borderlands: The Pre-Sequel Season Pass', to_date('2015.03.24', 'YYYY.MM.DD'), 29.99, 'Extend the lunar mayhem with the Borderlands: The Pre-Sequel Season Pass featuring new characters, challenges, missions, and more.', 3.2, 18, '2K Games');
insert into softwareTab values (softwareIdN.nextval, 'Shock Drop Slaughter pit', to_date('2014.12.16', 'YYYY.MM.DD'), 3.99, 'Enter the Shock Drop Slaughter Pit and face off against the toughest Scavs on Pandora''s moon, Elpis! Survive the battle and you''ll be feared and respected by the few left alive. Not to mention the experience and gear you''ll earn!', 1.4, 18, '2K Games');
...
insert into softwareTab values (softwareIdN.nextval, 'Borderlands 3 Season Pass', to_date('2020.03.13', 'YYYY.MM.DD'), 49.99, 'Continue your Borderlands 3 adventure with the Season Pass!', 3.2, 18, '2K Games');
...
insert into softwareTab values (softwareId.nextval, 'The Witcher 3: Wild Hunt - Blood and Wine', to_date('2016.05.20', 'YYYY.MM.DD'), 19.99,  'Become professional monster slayer Geralt of Rivia and explore Toussaint, a remote land untouched by war, where you will unravel the horrifying secret behind a beast terrorizing the kingdom. With all trails leading to dead ends, only a witcher can solve the mystery and survive the evil lurking in the night.', 4.8, 18, 'CD Projekt Red'); 
insert into softwareTab values (softwareId.nextval, 'The Witcher 3: Wild Hunt - Hearts of Stone', to_date('YYYY.MM.DD', 'YYYY.MM.DD'), 9.99,  'Step again into the shoes of Geralt of Rivia, a professional monster slayer, this time hired to defeat a ruthless bandit captain, Olgierd von Everec — a man who possesses the power of immortality.', 4.7, 18, 'CD Projekt Red');
...
--insert into softwareTab values (softwareId.nextval, 'name', to_date('YYYY.MM.DD', 'YYYY.MM.DD'), E.C,  'description', classification, ageRating, 'publisherName');        





--tabUser (userId, email, username, fullName, birthDate, region)
insert into tabUser values(userIdN.nextval, 'johnnyboy@gmail.com', 'johnnyboy74', 'John Cooper Smith', to_Date('2004.01.02', 'YYYY.MM.DD'), 'North America');
insert into tabUser values(userIdN.nextval, 'hellokitty@sapo.pt', 'hellokitty6', 'Andreia Alves', to_Date('1995.10.23', 'YYYY.MM.DD'), 'Western Europe');
insert into tabUser values(userIdN.nextval, 'micwarriorxd@sapo.pt', 'micwarriorXD', 'Miguel Francisco Rodrigues', to_Date('2006.07.15', 'YYYY.MM.DD'), 'South America');
insert into tabUser values(userIdN.nextval, '1beastfigther@gmail.com', '1beastfigther1', 'Rajesh Koothrappali', to_Date('1980.03.30', 'YYYY.MM.DD'), 'Central Asia');
insert into tabUser values(userIdN.nextval, 'youssefthebest@gmail.com', 'youssefthebest99', 'Youssef Alami', to_Date('1978.05.09', 'YYYY.MM.DD'), 'North Africa');
insert into tabUser values(userIdN.nextval, 'davhergamer@gmail.com', 'davher909', 'David Hernandez', to_Date('2002.07.26', 'YYYY.MM.DD'), 'Central America');
insert into tabUser values(userIdN.nextval, 'franciscocunhadasilva@sapo.pt', 'franciscosilva', 'Francisco Cunha da Silva', to_Date('1969.11.20', 'YYYY.MM.DD'), 'Western Europe');
insert into tabUser values(userIdN.nextval, 'dmitrikillall@sapo.pt', 'dmitrikillall', 'Dmitri Smirnov', to_Date('1992.12.01', 'YYYY.MM.DD'), 'Eastern Europe');
insert into tabUser values(userIdN.nextval, 'keyboardninja@gmail.com', 'keyboardninja420', 'Zhang Wei', to_Date('2000.01.13', 'YYYY.MM.DD'), 'East Asia');
insert into tabUser values(userIdN.nextval, 'gilmariogamer@gmail.com', 'gilmariogamer33', 'Gilmario Cossa', to_Date('1972.09.19', 'YYYY.MM.DD'), 'South Africa');
insert into tabUser values(userIdN.nextval, 'theaussietrain@gmail.com', 'theaussietrain', 'Charlotte Wilson', to_Date('2008.08.05', 'YYYY.MM.DD'), 'Oceania');
insert into tabUser values(userIdN.nextval, 'mualitheog@gmail.com', 'mualitheog', 'Muhammad Ali', to_Date('1962.11.25', 'YYYY.MM.DD'), 'Middle East');
insert into tabUser values(userIdN.nextval, 'thegoldgirl@sapo.pt', 'thegoldgirl01', 'Liudmila Julia Holub', to_Date('1984.04.08', 'YYYY.MM.DD'), 'Eastern Europe');
insert into tabUser values(userIdN.nextval, 'dieubeaofficial@sapo.pt', 'dieu_bea_official', 'Dieudonne Beatrice', to_Date('1979.05.02', 'YYYY.MM.DD'), 'Western Europe');
insert into tabUser values(userIdN.nextval, 'narutoirl@gmail.com', 'narutoirlgamer', 'Shinju Tatsuya Suzuki', to_Date('1999.10.17', 'YYYY.MM.DD'), 'East Asia');
insert into tabUser values(userIdN.nextval, 'minecraftislife@gmail.com', 'iloveminecraft3', 'Ntombi Bandile', to_Date('2003.09.18', 'YYYY.MM.DD'), 'South Africa');
insert into tabUser values(userIdN.nextval, 'oliverpeakyshelby@gmail.com', 'darealpeaky666', 'Oliver Shelby', to_Date('2010.06.01', 'YYYY.MM.DD'), 'Oceania');
insert into tabUser values(userIdN.nextval, 'anwershahdbusinessg@gmail.com', 'anwerbestfifaplayer', 'Anwer Shahd', to_Date('2005.04.13', 'YYYY.MM.DD'), 'Middle East');
insert into tabUser values(userIdN.nextval, 'kateberryitb@gmail.com', 'berryinthebush59', 'Kate Bush Perry', to_Date('1993.03.24', 'YYYY.MM.DD'), 'North America');
insert into tabUser values(userIdN.nextval, 'juangarciaper@sapo.pt', '1garciaelgato1', 'Juan Garcia Pereira', to_Date('1994.07.03', 'YYYY.MM.DD'), 'Western Europe');
insert into tabUser values(userIdN.nextval, 'whindthewind@sapo.pt', 'whindthewindbr', 'Whindersson Caetano', to_Date('1990.05.15', 'YYYY.MM.DD'), 'South America');
insert into tabUser values(userIdN.nextval, 'samirranjit@gmail.com', 'samiruarebreakinthecar', 'Samir Ranjit', to_Date('1975.02.28', 'YYYY.MM.DD'), 'Central Asia');
insert into tabUser values(userIdN.nextval, 'infamousnileguard@gmail.com', 'akiltheguard001', 'Akil Salah', to_Date('1988.10.09', 'YYYY.MM.DD'), 'North Africa');
insert into tabUser values(userIdN.nextval, 'dacrazycubancigar@gmail.com', 'cuban7cigar', 'Veronica Benita Fredrick', to_Date('1997.01.16', 'YYYY.MM.DD'), 'Central America');
insert into tabUser values(userIdN.nextval, 'karentherep@gmail.com', 'karenamerica50', 'Karen Texas', to_Date('1970.07.07', 'YYYY.MM.DD'), 'North America');
commit;

select * from tabUser;

--insert into tabUser values(userId.nextval, 'name@domain.com', 'username', 'fullname', YYYY.MM.DD, 'region');
...
--insert into transactionTab values (transactionId.nextval, YYYY.MM.DD, 'paymentType', recipientId, userId);
...
insert into reviewTab values (1, 3, 'Very good game! :)', 4.5, to_date('2022.04.05', 'YYYY.MM.DD'));
commit;
...
--definedTab (softwareId, tagId)
insert into definedTab values (1, 2);
commit;
--insert into definedTab values (softwareId, tagId);
...
insert into threadTab values(threadIdN.nextval, 'How can I increase fps in The Witcher 3?', to_Date('2016.08.25', 'YYYY.MM.DD'), 20);
insert into threadTab values(threadIdN.nextval, 'How to get money fast in GTA5?', to_Date('2018.11.02', 'YYYY.MM.DD'), 19);
insert into threadTab values(threadIdN.nextval, 'Are the Sims 4 expansion packs worth the money?', to_Date('2018.11.02', 'YYYY.MM.DD'), 15);
